  ...
  return (
    <div className="flex w-[100vw] h-[100vh] items-center justify-center">
      ...
      <div className="rounded-lg h-fit p-6 flex flex-col gap-4 bg-white w-300">
        ...
        <TextInput value={filteringText} setValue={(val) => setFilteringText(String(val))} placeholder="Tag Filtering"/>
        </div>
        <ReportTable monitoringItems={data as never} pause={handleTogglePause} play={handleTogglePause}/>
      </div>
    </div>
  );
}
